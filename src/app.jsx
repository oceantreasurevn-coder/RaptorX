        ...
        const launchPost = {
            ...
            timeline: {
                ...
                events: [
                    ...
                    { date: "28 JAN", city: "Paris", venue: "Palais de Tokyo Plaza", desc: { en: "Street Art Collab - Custom your RaptorX", fr: "Street Art Collab - Custom your RaptorX" } },
                        ...
                        <div className="container mx-auto px-4 sm:px-6 relative z-10">
                            ...
                            <div className="relative w-full max-w-7xl mx-auto grid md:grid-cols-3 gap-8 items-center collection-grid">
                                <div className="col-span-1 space-y-6 order-2 md:order-1 relative z-20 text-center md:text-left collection-panel">
                                    ...
                                    <div className="overflow-hidden">
                                        <img src="Scater%20RaptorX%20Quality.png" alt="Scater RaptorX Quality badge" className={`mx-auto md:mx-0 mt-3 mb-1 w-full max-w-[220px] sm:max-w-[260px] h-auto object-contain transition-all duration-500 delay-150 transform ${isAnimating ? 'translate-y-6 opacity-0' : 'translate-y-0 opacity-100'}`} loading="lazy" decoding="async" />
                                    </div>
